...
print '  Data = '. $sensorthree;
$sql = "INSERT INTO sensorthree (Datecheck,Sensordatathree,Date,Time) VALUES ('$format_check','$sensorthree','$format_date','$format_time')";
