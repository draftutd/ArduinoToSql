...
<center><h1>กราฟแสดงผลการบันทึกค่าการตรวจจับเซนเซอร์ตัวที่หนึ่ง</h1><div id="chart_div" style="height: 300px; width: 100%;"></div></center>
...
<div class="container" >
 ...
 <nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li <? if($page==$i){echo 'class="active"';}else {echo 'class="page-item"';}?>><a class="page-link" href="sensorone.php?Page=<?=$i?>"><?=$i?></a></li>
    <?}?>
